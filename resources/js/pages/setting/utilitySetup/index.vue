                ...
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <div class="d-sm-flex align-items-center">
                            <h5 class="mb-2 mb-sm-0 align-items-left">{{ translate('Utility Bill Setup') }} {{
                                translate('List') }} </h5>
                            <div class="ms-auto align-items-right">
                                <router-link :to="{ name: 'setting.utility.setup.add' }" class="btn btn-secondary m-1">
                                    {{ translate('Add') }} {{ translate('Utilities') }}
                                </router-link>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <template v-if="item.building">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    <router-link
                                                        :to="{ name: 'setting.utility.setup.edit', params: { id: item.id } }"
                                                        class="text-warning">
...
export default {
    ...
    methods: {
        ...
        deleteRow() {
            ...
            axios
                .delete(`/setting/utility-setups/${this.rowToDelete}`)
                .then((response) => {
