                ...
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <div class="d-sm-flex align-items-center">
                            <h5 class="mb-2 mb-sm-0 align-items-left"> {{ translate('Add') }} {{ translate('Building') }}
                            </h5>
                            <div class="ms-auto">
                                <router-link :to="{ name: 'building.list' }" class="btn btn-secondary m-1">{{
                                    translate('Building') }} {{ translate('List') }}</router-link>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card shadow-none bg-light border">
                                    <div class="card-body">
                                        <form @keydown="allErrors.clear($event.target.name)" @submit.prevent="submitForm"
                                            class="row g-3">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <label class="form-label">{{ translate('Building') }} {{
                                                    translate('Name') }} </label> <span class="text-danger">*</span>
                                                <input class="form-control" name="name" placeholder="Name" type="text"
                                                    v-model="form.name" />
                                                <span class="error text-danger text-bold ms-2 mt-2"
                                                    v-if="this.allErrors.has('name')"
                                                    v-text="this.allErrors.get('name')"></span>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <label class="form-label"> {{ translate('Contact') }} {{
                                                    translate('Name') }}</label> <span class="text-danger">*</span>
                                                <input class="form-control" name="contact_name" type="text"
                                                    v-model="form.contact_name" />
                                                <span class="error text-danger text-bold ms-2 mt-2"
                                                    v-if="this.allErrors.has('contact_name')"
                                                    v-text="this.allErrors.get('contact_name')"></span>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <label class="form-label"> {{ translate('Contact') }} {{
                                                    translate('Number') }}</label> <span class="text-danger">*</span>
                                                <input class="form-control" name="contact_number" type="text"
                                                    v-model="form.contact_number" />
                                                <span class="error text-danger text-bold ms-2 mt-2"
                                                    v-if="this.allErrors.has('contact_number')"
                                                    v-text="this.allErrors.get('contact_number')"></span>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <label class="form-label"> {{ translate('Floor') }} </label> <span
                                                    class="text-danger">*</span>
                                                <input class="form-control" name="floor" placeholder="How many floor"
                                                    type="number" v-model="form.floor" />
                                                <span class="error text-danger text-bold ms-2 mt-2"
                                                    v-if="this.allErrors.has('floor')"
                                                    v-text="this.allErrors.get('floor')"></span>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <label class="form-label"> {{ translate('Lift') }} </label>
                                            ...
                                            <LocationPicker :allErrors="allErrors" :form="form"
                                                colDef="col-lg-6 col-md-6 col-sm-12" />
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <label class="form-label">{{ translate('Street') }} </label>
                                                <input class="form-control" name="street" placeholder="Street address"
                                                    type="text" v-model="form.street" />
                                                <span class="error text-danger text-bold ms-2 mt-2"
                                                    v-if="this.allErrors.has('street')"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <span class="error text-danger text-bold ms-2 mt-2"
                                                    v-if="this.allErrors.has('post_code')"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <span class="error text-danger text-bold ms-2 mt-2"
                                                    v-if="this.allErrors.has('house_number')"
                                                    v-text="this.allErrors.get('house_number')"></span>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <label class="form-label">{{ translate('Details Info') }} </label>
                                                <textarea class="form-control" cols="4" name="details_info"
                                                    placeholder="Details Info" rows="4"
                                                    v-model="form.details_info"></textarea>
                                                <span class="error text-danger text-bold ms-2 mt-2"
                                                    v-if="this.allErrors.has('details_info')"
                                                    v-text="this.allErrors.get('details_info')"></span>
                                            </div>
                                            <imagePreview :allErrors="allErrors" :form="form" />
                                            <div class="col-lg-12 col-md-12 col-sm-12">
...
export default {
    components: { imagePreview, LocationPicker },
    data() {
        return {
