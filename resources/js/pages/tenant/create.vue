        ...
        <div class="card">
          <div class="card-header py-3 bg-transparent">
            <div class="d-sm-flex align-items-center">
              <h5 class="mb-2 mb-sm-0 align-items-left"> {{ translate('Add') }} {{ translate('Tenant') }}</h5>
              <div class="ms-auto">
                ...
                <div class="card shadow-none bg-light border">
                  <div class="card-body">
                    <form class="row g-3" @keydown="allErrors.clear($event.target.name)" @submit.prevent="submitForm">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        <label class="form-label"> {{ translate('Tenant') }}
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <input name="password" type="password" class="form-control" :placeholder="translate('Password')"
                          v-model="form.password" />
                        <span v-if="allErrors.has('password')" class="error text-danger text-bold ms-2 mt-2"
                          v-text="allErrors.get('password')"></span>
                      </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <input name="advanced_amount" type="number" class="form-control"
                          :placeholder="translate('Advanced Amount')" v-model="form.advanced_amount" />
                      ...
                      <imagePreviewSingle :form="form" :allErrors="allErrors" isRequired="true" />
...
export default {
  ...
  methods:
  {
    ...
    fetchFlat() {
      ...
      if (building_id) {
        axios
          .get(`/flats/available/building-wise/${building_id}`)
          .then((response) => {
    ...
    flatTenant() {
      this.flat_id = this.$route.params.flat_id;
      if (this.flat_id) {
        this.form.flat_id = this.flat_id;
        axios
          .get(`/flats/${this.flat_id}`)
          .then((response) => {
            this.form.building_id = response.data.building_id;
          })
          .catch((error) => {
            console.error(error);
          });
