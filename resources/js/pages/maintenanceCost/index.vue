                    ...
                    <div class="card-header py-3 bg-transparent">
                        <div class="d-sm-flex align-items-center">
                            ...
                            <div class="ms-auto align-items-right">
                                <router-link :to="{ name: 'maintenance.add' }" class="btn btn-secondary m-1">
                                    ...
                                    <tr v-for="item  in  data " :key="item.id">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3 fs-6">
                                                <router-link :to="{ name: 'maintenance.edit', params: { id: item.id } }"
                                                    class="text-warning">
                                                    <span class="material-symbols-outlined google-icon"
                                                        role="button">edit_square</span>
                                                </router-link>
                                                <!-- <a @click="deleteConfirmation(item.id)" class="text-danger"><span class="material-symbols-outlined google-icon"  role="button">delete</span></a> -->
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
...
export default {
    ...
    methods: {
        ...
        //     axios
        //         .delete(`/maintenance-costs/${this.rowToDelete}`)
        //         .then((response) => {
