                ...
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <div class="d-sm-flex align-items-center">
                            <h5 class="mb-2 mb-sm-0 align-items-left"> {{ translate('Edit') }} {{ translate('Member') }}
                            </h5>
                            <div class="ms-auto">
...
export default {
    components: { BuildingPicker, imagePreviewSingleEdit },
    data() {
        return {
    ...
    methods:
    {
        fetchData() {
            this.loader(true)
            axios
                .get(`/management-committe/${this.routeId}`)
                .then((response) => {
                    this.loader(false)
        ...
        submitForm() {
            this.loader(true)
            axios
                .put(`/management-committe/${this.routeId}`, this.form)
                .then((response) => {
                    this.loader(false)
