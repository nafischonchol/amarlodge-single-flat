                ...
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <div class="d-sm-flex align-items-center">
                            <h5 class="mb-2 mb-sm-0 align-items-left"> {{ translate('Add') }} {{ translate('Flat') }} </h5>
                            <div class="ms-auto">
                                <router-link to="/flat/list" class="btn btn-secondary m-1">
                                    {{ translate('Flat') }} {{ translate('List') }}
                                </router-link>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="row g-3" @keydown="allErrors.clear($event.target.name)"
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <label class="form-label">{{ translate('Rent') }}</label> <span
                                                    class="text-danger">*</span>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                ...
                                                <select name="type" class="form-control" v-model="form.rented_to_bachelors">
                                            ...
                                            <imagePreview :form="form" :allErrors="allErrors" isRequired="true" />
                                            <div class="col-lg-12 col-md-12 col-sm-12">
