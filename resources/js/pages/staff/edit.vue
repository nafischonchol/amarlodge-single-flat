                ...
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <div class="d-sm-flex align-items-center">
                            <h5 class="mb-2 mb-sm-0 align-items-left"> {{ translate('Edit') }} {{ translate('Staff') }}</h5>
                            <div class="ms-auto">
                                ...
                                <div class="card shadow-none bg-light border">
                                    <div class="card-body">
                                        <form class="row g-3" @keydown="allErrors.clear($event.target.name)"
                                            ...
                                            <input type="hidden" name="old_nid_image" v-model="form.old_nid_image" />
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <label class="form-label"> {{ translate('Staff') }} {{ translate('Type')
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <textarea class="form-control" placeholder="Full Address" rows="4" cols="4"
                                                    name="address" v-model="form.address"></textarea>
                                            ...
                                            <imagePreviewStaffEdit :form="form" :allErrors="allErrors" :image="image" />
                                            <div class="col-lg-12 col-md-12 col-sm-12">
...
import imagePreviewStaffEdit from "@/components/imagePreviewStaffEdit.vue";

export default {
    components: { imagePreviewStaffEdit },
    data() {
        return {
        ...
        fetchData() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.image = "/" + this.form['nid_image'];
                    this.form['old_nid_image'] = this.form['nid_image'];
                    this.form['nid_image'] = null;
                })
                .catch((error) => {
