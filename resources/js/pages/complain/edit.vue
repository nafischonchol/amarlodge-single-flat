                ...
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <div class="d-sm-flex align-items-center">
                            <h5 class="mb-2 mb-sm-0 align-items-left">{{ translate('Complain') }} {{ translate('Edit') }}
                            </h5>
                            <div class="ms-auto">
                                        ...
                                        <form class="row g-3" @keydown="allErrors.clear($event.target.name)"
                                            ...
                                            <div class="col-md-12 col-md-12 col-sm-12">
                                                ...
                                                <input name="title" type="text" class="form-control"
                                                    placeholder="Complain Title" v-model="form.title" />
                                            ...
                                            <div class="col-md-12 col-md-12 col-sm-12">
                                                <div>
                                                    <label class="form-label">{{ translate('Details') }} <span
...
export default {
    ...
    data() {
        return {
            ...
            complainId: this.$route.params.id,
            buildingList: [],
            flatList: [],
        };
    },
    methods:
    {
        ...
        fetchData() {
            return new Promise((resolve, reject) => {
                axios.get(`/complains/${this.complainId}`)
                    .then((response) => {
        ...
        submitForm() {
            ...
            axios
                .put(`/complains/${this.complainId}`, this.form)
                .then((response) => {
                    this.loader(false)
