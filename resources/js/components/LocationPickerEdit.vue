...
export default {
    ...
    watch: {
        ...
        'form.country_id': {
            ...
            handler(newVal) {
                if (newVal) {
                    this.fetchDivision(); // Trigger fetchDivision when the country_id is available
                }
            }
        },
        'form.division_id': {
            ...
            handler(newVal) {
                if (newVal) {
                    this.fetchDistrict(); // Trigger fetchDistrict when the division_id is available
                }
            }
        },
        'form.district_id': {
            ...
            handler(newVal) {
                if (newVal) {
                    this.fetchUpozila(); // Trigger fetchUpozila when the division_id is available
                }
            }
        }
    },
